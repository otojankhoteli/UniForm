import { usePostApiWithAuth, useGetApi, GetApiHookResult, usePostApi } from "../shared/ApiHook";
import { CreatePostRequest, GetPostsResponse, PostViewModel } from "./PostsApiModel";
import { CreatePostUri, GetFeedUri, DownvoteUri, UpvoteUri } from "./PostsApiUri";
