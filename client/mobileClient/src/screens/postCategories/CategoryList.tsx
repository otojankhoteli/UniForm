...
import { ScrollView, View, Text, RefreshControl, SafeAreaView, FlatList, NativeSyntheticEvent, NativeScrollEvent } from 'react-native'
...
export default function CategoryList({ isLoading, categories, onSelect, onRefresh, fetchNextPage, fetchPrevPage }: Props) {
  ...
  return <FlatList data={internalCategories}
    renderItem={category => (<CategoryListItem key={category.item.id} category={category.item} onCategoryClick={onSelect} />)}
